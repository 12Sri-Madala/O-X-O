...
// import fire from '../../Library/Native/Firebase.js';
import { Colors, Spacing, Icons } from '../../Library/Native/StyleGuide.js';
import { saveProfileImage } from '../Redux/actions.js';
...
class ProfileImage extends React.Component {
  ...
  async saveProfilePicture() {
    ...
    await AsyncStorage.setItem("profileImage", this.state.base64);
    console.log(token);
...
    );
  ...
  skipScreen() {
    this.props.navigation.navigate('AddressesLogin');
  }
