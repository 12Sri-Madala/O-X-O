...
import Footer from "../../Library/Native/Footer.js";
...
class MatchFound extends React.Component {
  constructor(props) {
    super(props);
    this.driver = this.props.drivers.find(driver => {
      return `${driver.id}` === this.props.matches[this.props.index].driverID;
    });
  ...
  confirm() {
    Alert.alert(
      "Confirm",
      "Remember, a small fee applied if you cancel less than 24 hours before a match.",
      [
        {
          text: "Cancel",
          onPress: () => {},
