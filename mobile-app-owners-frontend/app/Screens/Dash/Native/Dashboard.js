...
import Header from "../../Library/Native/Header.js";
import Loader from "../../Library/Native/Loader.js";
import { Colors } from "../../Library/Native/StyleGuide.js";
...
import { loadAddresses } from "../../Profile/Addresses/Redux/actions";
  ...
  */
  determineContent(match, index) {
    switch (match.status) {
      ...
      case "Unavailable":
        return (
          <EditAvailability index={index} navigation={this.props.navigation} />
        );
      default:
    }
  }
